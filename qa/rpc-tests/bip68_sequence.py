...
class BIP68Test(BitcoinTestFramework):
    ...
    def setup_network(self):
        self.nodes = []
        self.nodes.append(start_node(0, self.options.tmpdir, ["-whitelist=127.0.0.1", "-debug", "-blockprioritysize=0", "-blockchain.maxReorgDepth=-1"]))
        self.nodes.append(start_node(1, self.options.tmpdir, ["-whitelist=127.0.0.1", "-debug", "-blockprioritysize=0", "-acceptnonstdtxn=0", "-blockchain.maxReorgDepth=-1"]))
