...
class NodeHandlingTest (BitcoinTestFramework):
    def run_test(self):
        ...
        assert_equal("192.168.0.1/32", listBeforeShutdown[3]['address']) #must be here
        ...
        assert_equal("127.0.0.0/24", listAfterShutdown[1]['address'])
        assert_equal("127.0.0.0/32", listAfterShutdown[2]['address'])
        assert_equal("/19" in listAfterShutdown[0]['address'], True)
