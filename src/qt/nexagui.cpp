...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(
        tr("Request payments (generates QR codes and %1: URIs)").arg(GUIUtil::bitcoinURIScheme(*cfg)));
    ...
    tokensMenuAction = new QAction(platformStyle->TextColorIcon(":/icons/send"), tokensAction->text(), this);
    ...
    openAction->setStatusTip(tr("Open a %1: URI").arg(GUIUtil::bitcoinURIScheme(*cfg)));
...
// Configuration of the tray icon (or Dock icon) menu
    ...
    trayIconMenu->addAction(tokensMenuAction);
    trayIconMenu->addSeparator();
...
void BitcoinGUI::showHelpMessageClicked() { helpMessageDialog->show(); }
#ifdef ENABLE_WALLET
...
void BitcoinGUI::gotoTokensPage()
{
...
void UnitDisplayStatusBarControl::updateDisplayUnit(int newUnits) { setText(BitcoinUnits::name(newUnits)); }
