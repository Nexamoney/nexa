...
TrafficGraphWidget::TrafficGraphWidget(QWidget *parent)
    : QWidget(parent), timer(0), fMax(0.0f), nMins(0), vSamplesIn(), vSamplesOut(), nLastBytesIn(0), nLastBytesOut(0),
      clientModel(0)
{
...
void TrafficGraphWidget::updateRates()
{
    ...
    quint64 bytesIn = clientModel->getTotalBytesRecv(), bytesOut = clientModel->getTotalBytesSent();
