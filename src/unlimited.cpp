...
UniValue expedited(const UniValue &params, bool fHelp)
{
    if (fHelp || params.size() < 2)
        throw runtime_error("expedited block|tx \"node IP addr\" on|off\n"
                            ...
                            "\nExamples:\n" +
                            HelpExampleCli("expedited", "block \"192.168.0.6:7228\" on") +
                            HelpExampleRpc("expedited", "\"block\", \"192.168.0.6:7228\", \"on\""));
...
UniValue pushtx(const UniValue &params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error("pushtx \"node\"\n"
                            ...
                            "\nExamples:\n" +
                            HelpExampleCli("pushtx", "\"192.168.0.6:7228\" ") +
                            HelpExampleRpc("pushtx", "\"192.168.0.6:7228\", "));
